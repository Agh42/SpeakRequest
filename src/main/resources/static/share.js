...
(function(window) {
  ...
  function createIcon(type) {
    ...
    icon.style.cssText = 'margin-right: 8px; vertical-align: middle; width: 20px; height: 20px; font-size: 16px;';
    ...
    switch(type) {
      ...
      case 'close':
        ...
        break;
      default:
        // Use share-nodes for the general share icon (network with connected nodes)
